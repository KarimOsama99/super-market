...
import $ from 'jquery';
import "../helper/jquery-global.js";
...
const Header = () => {
    ...
    useEffect(() => {
        ...
        const timeout = setTimeout(() => {
          const selects = $(".js-example-basic-single");
          if (selects.length && typeof selects.select2 === "function") {
            selects.select2({
              width: "100%", // عشان يملأ العنصر
        ...
        return () => {
          ...
          const selects = $(".js-example-basic-single");
          if (selects.length && selects.data("select2")) {
                    ...
                    <div className="mobile-menu__menu">
                        ...
                        <ul className="nav-menu flex-align nav-menu--mobile">
                            ...
                            <li onClick={() => handleMenuClick(3)}
                                className={`on-hover-item nav-menu__item ${activeIndex === 3 ? "d-block" : ""
                                    }`}
                            >
                                <Link
                                    to="/blog"
                ...
                <div className="container container-lg">
                    <div className="flex-between flex-wrap gap-8">
                        ...
                        <ul className="header-top__right flex-align flex-wrap">
                            <li className="on-hover-item border-right-item border-right-item-sm-space arrow-white">
