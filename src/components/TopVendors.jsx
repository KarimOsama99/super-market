            ...
            <div className="vendor-card text-center px-16 pb-24">
              ...
              <div className="vendor-card__list mt-22 flex-center flex-wrap gap-8">
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="../src/assets/images/thumbs/vendor-img1.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="../src/assets/images/thumbs/vendor-img2.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="../src/assets/images/thumbs/vendor-img3.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="../src/assets/images/thumbs/vendor-img4.png"
                    alt=""
                  />
                </div>
                <div className="vendor-card__item bg-white rounded-circle flex-center">
                  <img
                    src="../src/assets/images/thumbs/vendor-img5.png"
                    alt=""
                  />
                </div>
              </div>
