...
const Footer = () => {
  return (
    <footer className="footer py-120">
      <img src={`${import.meta.env.BASE_URL}images/bg/body-bottom-bg.png`}
        alt="BG"
        ...
        <div className="footer-item-wrapper d-flex align-items-start flex-wrap">
          <div className="footer-item">
            <div className="footer-item__logo">
              <Link to="/">
                {" "}
                <img src={`${import.meta.env.BASE_URL}images/logo/logo.png`} alt="" />
              </Link>
            </div>
            <p className="mb-24">
          ...
          <div className="footer-item">
            ...
            <div className="flex-align gap-8 my-32">
              <Link to="/https://www.apple.com/store" className="">
                <img src={`${import.meta.env.BASE_URL}images/thumbs/store-img1.png`} alt="" />
              </Link>
              <Link to="/https://play.google.com/store/apps?hl=en" className="">
                <img src={`${import.meta.env.BASE_URL}images/thumbs/store-img2.png`} alt="" />
              </Link>
            </div>
